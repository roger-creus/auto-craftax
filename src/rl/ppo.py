...
if __name__ == "__main__":
    ...
    run_name = f"algo:PPO_env:{args.env_id}_seed:{args.seed}_{int(time.time())}"
    ...
    save_results_csv(args, "PPO", avg_ep_reward, avg_ep_length, avg_achievements, global_step, time.time() - start_time)